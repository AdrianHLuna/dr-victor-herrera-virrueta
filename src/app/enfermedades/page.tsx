            ...
            {filteredDiseases.map(disease => (
              <StaggerItem key={disease.id}>
                <Link 
                  ...
                  className="bg-white border border-slate-200 rounded-3xl p-8 hover:shadow-md hover:border-accent/20 transition-all duration-300 flex flex-col justify-between group h-full block"
                >
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-[9px] bg-slate-100 text-accent px-3 py-1 rounded-full font-bold uppercase tracking-wider flex items-center gap-1.5">
                        <FaBriefcaseMedical size={10} /> {getCategory(disease.slug)}
                      </span>
                    </div>

                    <h2 className="text-2xl font-bold text-slate-900 font-serif group-hover:text-accent transition-colors">
                      {disease.name}
                    </h2>
                  ...
                  <div className="pt-6 border-t border-slate-100 mt-6 flex justify-between items-center text-xs font-bold uppercase tracking-wider text-accent group-hover:text-primary transition-colors">
